...
See **[docs/schematics/wiring-diagram.md](docs/schematics/wiring-diagram.md)** for the full block diagram, GPIO map, and connection tables.

Additional docs:

- [DevKit wiring (PL)](docs/schematics/polaczenia-devkit-usb.md) — step-by-step breadboard guide
- [FireBeetle wiring (PL, target)](docs/schematics/polaczenia.md)
- [Design spec](docs/superpowers/specs/2026-08-25-szambo-level-sensor-design.md)
- [Implementation plan](docs/superpowers/plans/2026-08-25-szambo-level-sensor.md)
