...
Jeden plik YAML dla czujnika poziomu tanku: ESP32 DevKit V1, ultrasonik JSN-SR04T-V3.3, bateria 18650, MOSFET AO3401A (P-MOS high-side + NPN).

**Migracja AO3401A (2026-09):** etap 1 = `enable_deep_sleep: false` (logi USB co 30 s); etap 2 = `true` + `sleep_duration: 8h`.
...
5. Wraca do deep sleep na 8 godzin (od etapu 2 migracji AO3401A).
...
| `enable_deep_sleep` | `false` (etap 1) | Etap 1: logi USB; etap 2: `true` |
| `sleep_duration` | `8h` | Aktywne od etapu 2 |
| `enable_battery_check` | `true` | Progi software cutoff |
| `enable_sensor_power` | `true` | AO3401A + NPN na GPIO4 (HIGH = ON) |
